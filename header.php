									...
									<div class="clearfix f_right f_xs_none d_xs_inline_b m_xs_bottom_15 t_xs_align_l">
										...
										<div class="f_right m_right_3 relative transform3d">
											...
											<ul id="language" data-show="wicket" data-hide="wicketout" class="sub_menu dropdown fs_medium bg_grey_light second_font animated">
												<li>
													<a href="eng-index" class="sc_hover">
														<img src="images/flag_en.jpg" alt="" class="d_inline_m m_right_7">
														English
													</a>
												</li>
												<li>
													<a href="index" class="sc_hover">
					...
					<div class="container t_align_c" style="width:100%; !important">
						...
						<nav role="navigation" class="d_xs_none t_align_c t_xs_align_l">
							<ul class="main_menu hr_list d_inline_b d_xs_block t_sm_align_l relative second_font fs_medium t_align_l">
								<li><a href="index" class="tt_uppercase tr_delay">Sortiment</a></li>
								<li><a href="om-taste" class="tt_uppercase tr_delay">Om Taste</a></li>
								<li><a href="cake" class="tt_uppercase tr_delay">Kager</a></li>
								<li><a href="image?cat=Bryllupskager" class="tt_uppercase tr_delay">Bryllupskager</a></li>
								<li><a href="image?cat=Macarons" class="tt_uppercase tr_delay">Macarons</a></li>
								<li><a href="bistro" class="tt_uppercase tr_delay">Bistro </a></li>
								<li><a href="master-class" class="tt_uppercase tr_delay">Master-Class</a></li>
								<li><a href="catering" class="tt_uppercase tr_delay">Catering</a></li>
							    <li><a href="job" class="tt_uppercase tr_delay">Job</a></li>
							</ul>
						</nav>
					</div>
					<hr />
